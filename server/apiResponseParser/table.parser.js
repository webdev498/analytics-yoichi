...
function generateDataSource(props) {
...
export function processSingleColumnResponseData(rawData) {
  // let fieldMapping = rawData.tableData.fieldMapping ? rawData.tableData.fieldMapping : [];
  let tableDataSource = generateDataSource(rawData);
